...
png("../Figs/riself.png", width=1000, height=720, pointsize=24)
par(mar=rep(0.1,4),las=1,fg="white",col="white",col.axis="white",col.lab="white",
    bg=bgcolor,bty="n", lwd=2)
...
arrows(432,450,432,410,len=0.14)
...
arrows(c(319,545,92,772),rep(350,4),c(319,545,92,772),rep(330,4),len=0.14)
...
arrows(c(319,545,92,772),rep(270,4),c(319,545,92,772),rep(250,4),len=0.14)
...
arrows(c(319,545,92,772),rep(190,4),c(319,545,92,772),rep(170,4),len=0.14)
...
arrows(c(319,545,92,772),rep(85,4),c(319,545,92,772),rep(80,4),len=0.14)
arrows(c(319,545,92,772),rep(110,4),c(319,545,92,772),rep(80,4),len=0.14,lty=2)
